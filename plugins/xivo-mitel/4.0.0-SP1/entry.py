...
MODEL_VERSIONS = {
    u'6863i': u'4.0.0.1096',
    u'6865i': u'4.0.0.1096',
    u'6867i': u'4.0.0.1096',
    u'6869i': u'4.0.0.1096',
}


class MitelPlugin(common['BaseMitelPlugin']):
    IS_PLUGIN = True

    pg_associator = common['BaseMitelPgAssociator'](MODEL_VERSIONS)
