...
COMMON_FILES = {
    ...
    'F0V00X5S0000.cfg': ('X5S', 'x5s-6900-P0.16.5-1.12.2-3144T2019-07-23-14.20.37.z', 'model.tpl'),
    'F0V00X600000.cfg': ('X6', 'x6-6904-P0.16.5-1.12.2-3144T2019-07-29-15.09.59.z', 'model.tpl'),
    'F0000X600000.cfg': ('X6V2', 'x6-6914-P0.16.5-1.12.2-3144T2019-07-23-14.20.41.z', 'model.tpl'),
}
...
MODEL_FIRMWARE_MAPPING = {
    ...
    'X7': 'x7-6926-P0.17.0-1.12.5.1-3739T2019-11-07-18.19.52.z',
    'X7-Pro': 'x7upro-fanvil-release-6957-2.12.1.3-krnvlT2022-05-14-17.01.35.z',
    'X7C': 'x7c-6925-P0.17.0-1.12.2.1-3739T2019-11-07-18.27.06.z',
