...
COMMON_FILES = {
    'F0V10S00000.cfg': (
        'i10S',
        'I10S-fanvil-3921-full-V0.2.2-2.12.44.6-1864-D0.29.0-T2023-09-08-12.12.40.z',
        'model-i1x.tpl',
    ),
    'F0V10SV00000.cfg': (
        'i10SV',
        'I10SV-fanvil-3918-full-V0.2.2-2.12.44.6-1864-D0.29.0-T2023-09-08-12.26.54.z',
        'model-i1x.tpl',
    ),
    'F0V10SD00000.cfg': (
        'i10SD',
        'I10SD-fanvil-3922-full-V0.2.2-2.12.44.6-1864-D0.29.0-T2023-09-08-12.20.09.z',
        'model-i1x.tpl',
    ),
    ...
    'F0Vi51W00000.cfg': (
        'i51W',
        'i51w-fanvil-release-4900-2.12.44.10-krnvlT2023-10-16-16.58.43.z',
        'model-i5x.tpl',
    ),
    'F0Vi52W00000.cfg': (
        'i52W',
        'i52w-fanvil-release-4902-2.12.44.10-krnvlT2023-10-16-17.11.35.z',
        'model-i5x.tpl',
    ),
    'F0Vi53W00000.cfg': (
        'i53W',
    ...
    'F0V16S00000.cfg': (
        'i16S',
        'I16S-fanvil-3925-full-V0.2.2-2.12.44.6-1864-D0.29.0-T2023-09-08-12.32.55.z',
        'model-i1x.tpl',
    ),
    ...
    'F0V16SV00000.cfg': (
        'i16SV',
        'I16SV-fanvil-3919-full-V0.2.2-2.12.44.6-1864-D0.29.0-T2023-09-08-12.39.00.z',
        'model-i1x.tpl',
    ),
    ...
    'F0V0i6100000.cfg': (
        'i61',
        'I61-fanvil-3940-full-V0.2.2-2.12.44.8.4-1877-D0.29.0-T2024-01-31-11.28.20.z',
        'model-i6x.tpl',
    ),
    ...
    'F0V0i6200000.cfg': (
        'i62',
        'I62-fanvil-3941-full-V0.2.2-2.12.44.8.4-1877-D0.29.0-T2024-01-31-11.35.41.z',
        'model-i6x.tpl',
    ),
    ...
    'F0V0i6300000.cfg': (
        'i63',
        'I63-fanvil-3942-full-V0.2.2-2.12.44.8.4-1877-D0.29.0-T2024-01-31-11.45.30.z',
        'model-i6x.tpl',
    ),
    ...
    'F0V0i6400000.cfg': (
        'i64',
        'I64-fanvil-3943-full-V0.2.2-2.12.44.8.4-1877-D0.29.0-T2024-01-31-11.52.44.z',
        'model-i6x.tpl',
    ),
...
MODEL_FIRMWARE_MAPPING = {
    'i10S': 'I10S-fanvil-3921-full-V0.2.2-2.12.44.6-1864-D0.29.0-T2023-09-08-12.12.40.z',
    'i10SV': 'I10SV-fanvil-3918-full-V0.2.2-2.12.44.6-1864-D0.29.0-T2023-09-08-12.26.54.z',
    ...
    'i62': 'I62-fanvil-3941-full-V0.2.2-2.12.44.8.4-1877-D0.29.0-T2024-01-31-11.35.41.z',
    'i63': 'I63-fanvil-3942-full-V0.2.2-2.12.44.8.4-1877-D0.29.0-T2024-01-31-11.45.30.z',
    'i64': 'I64-fanvil-3943-full-V0.2.2-2.12.44.8.4-1877-D0.29.0-T2024-01-31-11.52.44.z',
}
