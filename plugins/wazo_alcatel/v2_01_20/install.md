...
phone from another way. If your password contains characters other than digits,
the default password `000000` will be used.


## Installing dependencies on Debian

```
$ apt-get install python3-pexpect telnet
```
