...
account.{{ line_no }}.sip_server_host = {{ line['proxy_ip'] }}
account.{{ line_no }}.sip_server_port = {{ line['proxy_port']|d('%NULL%') }}
...
account.{{ line_no }}.sip_server_host = %NULL%
account.{{ line_no }}.sip_server_port = %NULL%
