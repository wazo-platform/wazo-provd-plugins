...
MODEL_VERSIONS = {
    ...
    u'T23G': u'44.84.0.15',  # 44.84.0.90 version does not support YDMP and YMCS
    u'T27G': u'69.84.0.90',
    u'T40P': u'54.84.0.15',  # 54.84.0.90 version does not support YDMP and YMCS
    u'T40G': u'76.84.0.15',  # 76.84.0.90 version does not support YDMP and YMCS
    u'T41S': u'66.84.0.90',
    u'T42S': u'66.84.0.90',
    u'T46S': u'66.84.0.90',
    u'T48S': u'66.84.0.90',
...
COMMON_FILES = [
    ...
    ('y000000000069.cfg', u'T27G-69.84.0.90.rom', 'model.tpl'),
    ...
    ('y000000000065.cfg', u'T46S(T48S,T42S,T41S)-66.84.0.90.rom', 'model.tpl'),
    ('y000000000066.cfg', u'T46S(T48S,T42S,T41S)-66.84.0.90.rom', 'model.tpl'),
    ('y000000000067.cfg', u'T46S(T48S,T42S,T41S)-66.84.0.90.rom', 'model.tpl'),
    ('y000000000068.cfg', u'T46S(T48S,T42S,T41S)-66.84.0.90.rom', 'model.tpl'),
    ('y000000000095.cfg', u'T53W(T53)-95.84.0.95.rom', 'model.tpl'),
