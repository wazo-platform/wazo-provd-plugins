...
<settings>
  <phone-settings e="2">
    ...
    <call_screen_fkeys_on_connected perm="">F_LEFT F_RIGHT F_CONF_ON F_HOLD transfer(not:Transfer)
    F_DUAL_AUDIO(not:Conference) F_DELETE_MSG F_CALLRECORD_CONTROL_ON</call_screen_fkeys_on_connected>
    <call_screen_fkeys_on_holding perm="">F_LEFT F_RIGHT F_CONF_ON(not:Transfer) F_DIAL(Transfer)
