...
COMMON_FILES = [
    ...
    ('F0V00X3S0000.cfg', u'x3s2.3.2.4638T20171221090439.z', 'model.tpl'),
    ('f0X4hw1.100.cfg', u'x42.3.2.4638T20171221091314.z', 'model.tpl'),
    ('F0V00X500000.cfg', u'x51.4.0.2016T20170303151233.z', 'model.tpl'),
    ('F0V00X5S0000.cfg', u'x5s-6900-P0.10.4-1.2.4-2146T2017-12-12-15.21.01.z', 'model.tpl'),
    ('F0V00X600000.cfg', u'x6-6914-P0.10.4-1.2.4-2142T2017-12-11-19.13.38.z', 'model.tpl'),
]
