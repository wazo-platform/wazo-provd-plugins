...
class TestPlugin(object):
    @patch('v82.common.FetchfwPluginHelper')
    ...
    def test_common_configure(self, v82_plugin):
        ...
        assert len(v82_plugin._tpl_helper.dump.mock_calls) == 13
    ...
    def test_configure(self, v82_plugin):
        ...
        v82_plugin._tpl_helper.get_dev_template.assert_called_with('805ec0d57d72.cfg', device)
    ...
    def test_get_remote_state_trigger_filename(self, v82_plugin):
        ...
        assert v82_plugin.get_remote_state_trigger_filename(
            {'mac': '80:5e:c0:d5:7d:72'}
        ) == '805ec0d57d72.cfg'
