...
{% for line_no, line in sip_lines.iteritems() %}
    ...
    <SYMB_ITEM ID="BS_IP_Data1.aucS_STUN_SERVER{{ line_suffix }}" class="symb_item" value='"stun.wazo.io"'/>
    ...
    <SYMB_ITEM ID="BS_IP_Data1.ucB_SIP_USE_STUN{{ line_suffix }}" class="symb_item" value="0x1"/>
