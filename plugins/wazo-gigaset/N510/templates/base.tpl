...
-->
    ...
    {%- if http_port %}
    <S_SPECIAL_DATA_SRV class="string" value='"http://{{ ip }}:{{ http_port }}/Gigaset/merkur262_42.bin?mac={{ XX_mac_addr }}&merkur262_42.bin"'/>
    {%- endif %}
...
<!-- WEB UI: Settings - Management - Firmware update - Data Server
    ...
    <SYMB_ITEM ID="BS_IP_Data1.aucS_USER_FIRMWARE_URL" class="string" value='"{{ ip }}:{{ http_port }}/Gigaset/merkur262_42.bin"' />
