...
<ProviderFrame xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="N720_general.xsd">
    ...
    <!-- NetDirectory settings
        <SYMB_ITEM ID="BS_XML_Netdirs.aucAvailableNetdirs[%]" class="symb_item" value="0"/>
        <SYMB_ITEM ID="BS_XML_Netdirs.aucActivatedNetdirs[%]" class="symb_item" value="0"/>
        ...
        <SYMB_ITEM ID="BS_XML_Netdirs.astNetdirProvider[%].aucProviderName[%]" class="symb_item" value='""'/>
        <SYMB_ITEM ID="BS_XML_Netdirs.astNetdirProvider[%].aucWhitePagesDirName[%]" class="symb_item" value='""'/>
        <SYMB_ITEM ID="BS_XML_Netdirs.astNetdirProvider[%].aucYellowPagesDirName[%]" class="symb_item" value='""'/>
        <SYMB_ITEM ID="BS_XML_Netdirs.astNetdirProvider[%].aucPrivatePagesDirName[%]" class="symb_item" value='""'/>
        <SYMB_ITEM ID="BS_XML_Netdirs.astNetdirProvider[%].aucUsername[%]" class="symb_item" value='""'/>
        <SYMB_ITEM ID="BS_XML_Netdirs.astNetdirProvider[%].aucPassword[%]" class="symb_item" value='""'/>
        <SYMB_ITEM ID="BS_XML_Netdirs.astNetdirProvider[%].aucServerURL[%]" class="symb_item" value='""'/>
        <SYMB_ITEM ID="BS_XML_Netdirs.astNetdirProvider[%].ucAuthPossibilities" class="symb_item" value="0"/>
        <SYMB_ITEM ID="BS_XML_Netdirs.astNetdirProvider[%].aucCountryCode[%]" class="symb_item" value='""'/>
        <SYMB_ITEM ID="BS_XML_Netdirs.astNetdirProvider[%].bitfldCap.bSearchPeopleCap" class="symb_item" value="1"/>
        <SYMB_ITEM ID="BS_XML_Netdirs.astNetdirProvider[%].bitfldCap.bSearchBusinessCap" class="symb_item" value="1"/>
        <SYMB_ITEM ID="BS_XML_Netdirs.astNetdirProvider[%].bitfldCap.bReverseSearchCap" class="symb_item" value="1"/>
        <SYMB_ITEM ID="BS_XML_Netdirs.astNetdirProvider[%].bitfldCap.bAutolookupCap" class="symb_item" value="1"/>
        <SYMB_ITEM ID="BS_XML_Netdirs.astNetdirProvider[%].bitfldCap.bPrivateDirectoryCap" class="symb_item" value="0"/>
        <SYMB_ITEM ID="BS_XML_Netdirs.astNetdirProvider[%].bitfldCap.bPrivateDirectoryNicknameCap" class="symb_item" value="0"/>
        <SYMB_ITEM ID="BS_XML_Netdirs.astNetdirProvider[%].bitfldCap.bSndMacAddress" class="symb_item" value="1"/>
        <SYMB_ITEM ID="BS_XML_Netdirs.astNetdirProvider[%].bitfldCap.bEncryptPosts" class="symb_item" value="0"/>
        -->
    <!-- LDAP settings 
    ...
    <!-- Local settings - Data -->	
        ...
        <SYMB_ITEM ID="BS_IP_Data.aucS_DATA_SERVER[%]" class="symb_item" value='"profile.gigaset.net/device"'/>
    ...
    <!--		
        ...
        <SYMB_ITEM ID="BS_IP_Data.ulI_DNS_SERVER_1" class="symb_item" value="0"/>
        ...
        <SYMB_ITEM ID="BS_IP_Data.ucB_VLAN_ENABLED" class="symb_item" value="0"/>
        <SYMB_ITEM ID="BS_IP_Data.ucI_VLAN_PRIORITY" class="symb_item" value="0"/>
        <SYMB_ITEM ID="BS_IP_Data.uiI_VLAN_ID" class="symb_item" value="0x0000"/>
    ...
    -->
    <!--
        <SYMB_ITEM ID="BS_IP_Data.aucS_TIME_NTP_SERVER[%]" class="symb_item" value='"europe.pool.ntp.org"'/>
        ...
        <SYMB_ITEM ID="BS_IP_Data.uiI_TIME_COUNTRY" class="symb_item" value="0x0019"/>
        <SYMB_ITEM ID="BS_IP_Data.uiI_TIME_TIMEZONE" class="symb_item" value="0x001B"/>
    ...
    <!-- Settings for VOIP and SIP
        ...
        <SYMB_ITEM ID="BS_VOIP_Data.uiI_SIP_LOCAL_PORT" class="symb_item" value="0x13c4"/>
        ...
        <SYMB_ITEM ID="BS_VOIP_Data.astVoipProviders[%].ucONESHOT_PROVISIONING_MODE_1" class="symb_item" value="1"/>
    ...
    <!-- Genaral settings for 100 VoIP accounts-->
        ...
        <SYMB_ITEM ID="BS_VOIP_Data.astVoipProviders[0].aucSIP_PROVIDER_NAME[%]" class="symb_item" value='"ProviderName"'/>
        <SYMB_ITEM ID="BS_VOIP_Data.astVoipProviders[0].aucSIP_DOMAIN[%]" class="symb_item" value='"Domain URL"'/>
        <SYMB_ITEM ID="BS_VOIP_Data.astVoipProviders[0].aucSIP_SERVER[%]" class="symb_item" value='"Server URL"'/>
        <SYMB_ITEM ID="BS_VOIP_Data.astVoipProviders[0].uiSIP_SERVER_PORT" class="symb_item" value="0x13c4"/>
        <SYMB_ITEM ID="BS_VOIP_Data.astVoipProviders[0].aucSIP_REGISTRAR[%]" class="symb_item" value='""'/>
        <SYMB_ITEM ID="BS_VOIP_Data.astVoipProviders[0].uiSIP_REGISTRAR_PORT" class="symb_item" value="0x13c4"/>
        ...
        <SYMB_ITEM ID="BS_VOIP_Data.astVoipProviders[0].aucOUTBOUND_PROXY[%]" class="symb_item" value='""'/>
        <SYMB_ITEM ID="BS_VOIP_Data.astVoipProviders[0].uiOUTBOUND_PROXY_PORT" class="symb_item" value="0x13c4"/>
        <SYMB_ITEM ID="BS_VOIP_Data.astVoipProviders[0].aucCURRENT_PROFILE_NAME[0]" class="symb_item" value='""'/>
    ...
    <!--VoIP 1 -->
        <SYMB_ITEM ID="BS_VOIP_Data.astVoipAccounts[0].aucS_SIP_DISPLAYNAME[0]" class="symb_item" value='"SIP1"'/>
        <SYMB_ITEM ID="BS_VOIP_Data.astVoipAccounts[0].aucS_SIP_LOGIN_ID[0]" class="symb_item" value='"Test"'/>
        <SYMB_ITEM ID="BS_VOIP_Data.astVoipAccounts[0].aucS_SIP_PASSWORD[0]" class="symb_item" value='"1234"'/>
        <SYMB_ITEM ID="BS_VOIP_Data.astVoipAccounts[0].aucS_SIP_USER_ID[0]" class="symb_item" value='"1234"'/>
        <SYMB_ITEM ID="BS_VOIP_Data.astVoipAccounts[0].ucB_SIP_ACCOUNT_IS_ACTIVE_1" class="symb_item" value="1"/>
        <SYMB_ITEM ID="BS_VOIP_Data.astVoipAccounts[0].ucB_VOIP_NET_AM_ENABLED_1" class="symb_item" value="0"/>
        <SYMB_ITEM ID="BS_VOIP_Data.astVoipAccounts[0].aucS_SIP_ACCOUNT_NAME_1[0]" class="symb_item" value='"Account1"'/>
    </Provider>
</ProviderFrame>