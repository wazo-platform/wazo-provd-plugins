...
class TestInfoExtraction:
    ...
    @patch('plugins.wazo_yealink.v84.common.defer')
...
class TestPluginAssociation:
    def test_plugin_association_when_all_info_match(self, v84_entry):
        plugin_associator = BaseYealinkPgAssociator(v84_entry.MODEL_INFO)
        for model, info in v84_entry.MODEL_INFO.items():
            assert (
    ...
    def test_plugin_association_when_only_vendor_and_model_match(self, v84_entry):
        plugin_associator = BaseYealinkPgAssociator(v84_entry.MODEL_INFO)
        for model in v84_entry.MODEL_INFO:
            assert (
...
class TestPlugin:
    @patch('plugins.wazo_yealink.v84.common.FetchfwPluginHelper')
    def test_init(self, fetch_fw, v84_entry):
        ...
        plugin = v84_entry.YealinkPlugin(
    ...
    def test_configure(self, v84_plugin):
        ...
        v84_plugin._tpl_helper.get_dev_template.assert_called_with(
    ...
    @patch('plugins.wazo_yealink.v84.common.synchronize')
    ...
    def test_get_remote_state_trigger_filename(self, v84_plugin):
        ...
        assert (
            v84_plugin.get_remote_state_trigger_filename({'mac': '80:5e:c0:d5:7d:72'})
            == '805ec0d57d72.cfg'
        )
    ...
    def test_function_keys(self, mocked_logger, v84_plugin):
        ...
        mocked_logger.info.assert_called_with(
            'Unknown model %s; no memorykey will be configured', 'T38G'
        )
        mocked_logger.reset_mock()
