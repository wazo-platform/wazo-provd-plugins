...
class TestInfoExtraction:
    ...
    @patch('plugins.wazo_yealink.v85.common.defer')
    ...
    @patch('plugins.wazo_yealink.v85.common.logger')
...
class TestPlugin:
    @patch('plugins.wazo_yealink.v85.common.FetchfwPluginHelper')
    def test_init(self, fetch_fw, v85_entry):
        ...
        plugin = v85_entry.YealinkPlugin(
    ...
    def test_configure(self, v85_plugin):
        ...
        v85_plugin._tpl_helper.get_dev_template.assert_called_with(
    ...
    @patch('plugins.wazo_yealink.v85.common.synchronize')
    ...
    def test_get_remote_state_trigger_filename(self, v85_plugin):
        ...
        assert (
            v85_plugin.get_remote_state_trigger_filename({'mac': '80:5e:c0:d5:7d:72'})
            == '805ec0d57d72.cfg'
        )
